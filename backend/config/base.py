...
LOGIN_REDIRECT_URL = "/"
ACCOUNT_LOGOUT_REDIRECT_URL = reverse_lazy('userapp:login')
...
DATABASES = {
    "default": {
        "ENGINE":CONFIG_SECRET["DB_ENGINE"],
        "NAME": CONFIG_SECRET["DB_NAME"],
        "USER":CONFIG_SECRET["DB_USER"],
        "PASSWORD":CONFIG_SECRET["DB_PASSWORD"],
        "HOST":CONFIG_SECRET["DB_HOST"],
        "PORT":CONFIG_SECRET["DB_PORT"]
    }
}
